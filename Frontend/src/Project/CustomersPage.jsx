        ...
        <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between border-b border-slate-800 pb-6">
          <div>
            ...
            <p className="text-slate-400 text-sm mt-2">
              Track all customers who submitted support tickets to your workspace.
            </p>
          </div>
          ...
          {loading ? (
            ...
            <div className="space-y-4">
              {filteredCustomers.map((customer) => (
                <div
                  key={customer._id}
                  className="bg-[#020617] border border-slate-800 rounded-2xl px-6 py-5 flex justify-between items-center hover:border-indigo-500/40 transition"
                >
                  <div>
